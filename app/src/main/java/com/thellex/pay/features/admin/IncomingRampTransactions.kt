package com.thellex.pay.features.admin
...
import com.thellex.pay.core.decorators.Green
...
import com.thellex.pay.data.model.AdminRampTransactionDTO
...
fun TransactionItem(
    ...
    Column(
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
            ...
            Text("${transaction.mainCryptoAmount} ${transaction.recipientInfo.assetCode.uppercase()}", color = GoldenYellow, fontFamily = KumbhSansFontFamily, fontWeight = FontWeight.Bold)
        }
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
            ...
            Box(
                ...
                Text(transaction.recipientInfo.destinationAddress.uppercase(), color = White, fontSize = 8.sp, fontFamily = KumbhSansFontFamily, fontWeight = FontWeight.Bold)
            }
        }
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
            ...
            Box(
                ...
                Text(Helpers.formatNetworkName(transaction.recipientInfo.network).uppercase(), color = White, fontSize = 10.sp, fontFamily = KumbhSansFontFamily, fontWeight = FontWeight.Bold)
            }
        }
